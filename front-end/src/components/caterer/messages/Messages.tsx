// components/caterer/messages/Messages.tsx
'use client';
...
export default function Messages() {
  ...
  useEffect(() => {
    setLoading(true);
    api
      .get('caterer/conversations') // adapte à ta vraie route
      .then((res) => {
  ...
  useEffect(() => {
    ...
    api
      .get(`caterer/conversations/${selectedId}/messages`)
  ...
  const handleSend = async () => {
    ...
    try {
      await api.post(`caterer/conversations/${selectedId}/messages`, { content: draft });
    } catch {
